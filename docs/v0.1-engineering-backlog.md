# v0.1 Engineering Backlog - AI-Powered Migration Generator

## 1. Release Objective

- Product Type: CLI
- Primary Command/API: migration-gen
- v0.1 Goal: Generate forward, rollback, and data migrations from schema diffs with impact notes.
...
before schema, after schema, optional migration policy config

### Outputs

sql forward file, sql rollback file, data migration stubs, impact report
...
- Core Acceptance Test: Given schema diff fixture, command generates valid SQL forward+rollback scripts and impact report sections.
